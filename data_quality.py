...
class DataQualityOperator(BaseOperator):
    """
    Checks the counts in the list of tables to determine if they passed Data Quality Validation
    
    :param redshift_conn_id: Redshift connection ID
    :param tables: List of tables passed for Data Quality Validation 
    """
